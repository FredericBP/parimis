<main>
    ...
    <section>
        <!-- FIL D'ARIANE -->
        <div class="ariane">
            <p><a href="index.php?page=accueil">Accueil</a> > <a href="index.php?page=chambres">Chambres & Suites</a> > Chambre Confort</p>
        </div>
        
        <!-- CARROUSEL PAGE CHAMBRE -->
        <div class="s-wrap s-type-1 s-room2" role="slider" aria-valuenow="4" aria-valuemin="1" aria-valuemax="10">
        ...
        <div class="description">
            ...
            <p>La Chambre Confort, baignée de lumière naturelle, cultive un luxe atypique mêlant raffinement et élégance. Une attention particulière a été portée à chaque détail afin que votre séjour soit confortable et agréable.</p>
            <p>Vivez un moment de détente dans un luxe discret.</p>
            <p>A partir de 330€/nuit</p>
        </div>
        <div class="services">
            ...
            <ul>
                ...
                <li>23m²</li>
                <li>Lit Queen-Size et King size</li>
